<template>
    <div>
        ...
        <i-panel title=" ">
            <i-cell title="客户来源" :value="addList.cues" is-link  i-class="simple_cell" i-cell-text="color_495060_text" request @click="cueFocus($event,1)"></i-cell>
            <i-cell title="客户分类" :value="addList.levels" is-link  i-class="simple_cell" i-cell-text="color_495060_text" request @click="cueFocus($event,2)"></i-cell>
