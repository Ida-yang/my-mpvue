<template>
    <div class="add_or_update_wrap">
        ...
        <i-panel title=" ">
            <i-cell title="拜访公司" :value="addList.customerName" request is-link  i-class="simple_cell" i-cell-text="color_495060_text" @click="cellFocus($event,1)"></i-cell>
            ...
            <i-cell title="拜访对象" :value="addList.contact" request is-link  i-class="simple_cell" i-cell-text="color_495060_text" @click="cellFocus($event,2)"></i-cell>
            <i-input v-model="addList.visitTheme" title="拜访主题" right request maxlength="50" @input="handleInput($event,1)" />
            <i-input v-model="addList.visitObjective" title="拜访目的" right request type="textarea" maxlength="200" @input="handleInput($event,2)" />
            <i-cell title="协助人员" :value="addList.assistants" is-link  i-class="simple_cell" i-cell-text="color_495060_text" @click="cellFocus($event,3)"></i-cell>
