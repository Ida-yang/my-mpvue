    ...
    export default {
        ...
        methods: {
            loadData(){
                ...
                wx.request({
                    method:'post',
                    url: config.defaulthost + 'customerpool/querypool.do?cId=' + config.userData.cId,  //接口地址
                    data: data,
                    header:{
            ...
            toCustomerPoolDetail(e,val){
                const url = 'customerPoolDetail/main'
                config.information.customerPoolDetailData = val
