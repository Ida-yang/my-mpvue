<template>
    <div>
        ...
        <i-panel :title="opportunityName">
            ...
            <i-cell title="公司名称" :value="updateList.poolName" request is-link  i-class="simple_cell" i-cell-text="color_495060_text" @click="cellFocus($event,1)"></i-cell>
            <i-cell title="客户决策人" :value="updateList.contact" request is-link  i-class="simple_cell" i-cell-text="color_495060_text" @click="cellFocus($event,2)"></i-cell>
