    ...
    <div class="contact_wrap">
        ...
        <i-swipeout i-class="i-swipeout-demo-item" :operateWidth="60" v-for="item in tableData" :key="item.id">
            ...
            <view slot="button" class="i-swipeout-button">
                <view class="i-swipeout-button-item" style="width:60px;background-color:#f5f5f5" @click="toUpdateContact($event,item)">
    ...
    export default {
        ...
        methods: {
            ...
            toAddContact(){
                ...
                wx.request({
                    url: config.defaulthost + 'contactsJurisdiction/insert.do',  //接口地址
                    header:{
                        'Cookie': config.SESSIONID
                    },
                    success:function(res) {
            ...
            toUpdateContact(e,val){
                ...
                wx.request({
                    url: config.defaulthost + 'contactsJurisdiction/update.do',  //接口地址
                    header:{
                        'Cookie': config.SESSIONID
                    },
                    success:function(res) {
