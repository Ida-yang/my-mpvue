<template>
    <div class="message_wrap">
        ...
        <i-cell-group>
            <i-cell v-for="(item,index) in tableData" :key="index" :title="item.customerpoolName" :label="item.backNo" i-class="group_cell_content" @click="toPayBack(item)">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            toPayBack(val){
                // contract_id
                const url = '../../packageA/payCollection/payCollectionDetail/main'
