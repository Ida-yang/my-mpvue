...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__index__ = __webpack_require__(355);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_b7128c26_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(358);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_b7128c26_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\pages\\task\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b7128c26", Component.options)
  } else {
    hotAPI.reload("data-v-b7128c26", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
    data: function data() {
        return {
            ...
            powerActive: '1',
            timeList: [{ label: '2', name: '昨天' }, { label: '1', name: '今天' }, { label: '5', name: '明天' }, { label: '3', name: '本周' }, { label: '6', name: '本月' }, { label: '7', name: '上月' }, { label: '8', name: '下月' }],
            timeActive: '-1',
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b7128c26", esExports)
  }
}
