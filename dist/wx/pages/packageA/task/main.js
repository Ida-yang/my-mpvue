...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__index__ = __webpack_require__(446);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__(448);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_b2dead72_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(449);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_b2dead72_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\pages\\packageA\\task\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b2dead72", Component.options)
  } else {
    hotAPI.reload("data-v-b2dead72", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        loadData: function loadData() {
            ...
            wx.request({
                method: 'post',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].defaulthost + 'workPlan/selectWorkPlan.do?cId=' + __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].userData.cId, //接口地址
                data: data,
                header: {
        ...
        toAddTask: function toAddTask() {
            var _this = this;

            wx.request({
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].defaulthost + 'workPlanJurisdiction/insert.do', //接口地址
                header: {
                    'Cookie': __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].SESSIONID
                },
                success: function success(res) {
        ...
        toUpdateTask: function toUpdateTask(e, val) {
            if (val.state == '已完成') {
                Object(__WEBPACK_IMPORTED_MODULE_1__dist_wx_iview_base_index__["$Toast"])({
                    content: '不可编辑',
                    type: 'warning'
                ...
                wx.request({
                    url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].defaulthost + 'workPlanJurisdiction/update.do', //接口地址
                    header: {
                        'Cookie': __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].SESSIONID
                    },
                    success: function success(res) {
                        var info = res.data.msg;
                        if (info == 'success') {
                            var url = 'taskUpdate/main';
                            __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].information.taskupdateData = val;
                            global.mpvue.navigateTo({ url: url });
                        } else if (info == 'error') {
                            Object(__WEBPACK_IMPORTED_MODULE_1__dist_wx_iview_base_index__["$Toast"])({
                                content: '对不起，您没有此权限',
        ...
        toTaskDetail: function toTaskDetail(e, val) {
            var url = 'taskDetail/main';
            __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].information.taskDetailData = val;
            global.mpvue.navigateTo({ url: url });
        }
    }
});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b2dead72", esExports)
  }
}
