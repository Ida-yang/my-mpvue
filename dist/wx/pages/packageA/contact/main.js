...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_2614b6f4_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(258);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_2614b6f4_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\pages\\packageA\\contact\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2614b6f4", Component.options)
  } else {
    hotAPI.reload("data-v-2614b6f4", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        powerCriteria: function powerCriteria(item, index, val) {
            ...
            var queryUrl = '';
            if (item.label == '11') {
                queryUrl = 'contactsJurisdiction/all.do';
            } else if (item.label == '13') {
                queryUrl = 'contactsJurisdiction/second.do';
            } else if (item.label == '14') {
                queryUrl = 'contactsJurisdiction/dept.do';
            }
        ...
        toAddContact: function toAddContact() {
            ...
            wx.request({
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].defaulthost + 'contactsJurisdiction/insert.do', //接口地址
                header: {
                    'Cookie': __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].SESSIONID
                },
                success: function success(res) {
        ...
        toUpdateContact: function toUpdateContact(e, val) {
            ...
            wx.request({
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].defaulthost + 'contactsJurisdiction/update.do', //接口地址
                header: {
                    'Cookie': __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].SESSIONID
                },
                success: function success(res) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2614b6f4", esExports)
  }
}
