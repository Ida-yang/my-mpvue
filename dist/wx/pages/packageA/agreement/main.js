...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_73f7fe1e_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(203);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_73f7fe1e_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\pages\\packageA\\agreement\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-73f7fe1e", Component.options)
  } else {
    hotAPI.reload("data-v-73f7fe1e", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
    data: function data() {
        return {
            ...
            predList: [{ label: '1', name: '服务合同' }, { label: '2', name: '销售合同' }, { label: '3', name: '代理合同' }, { label: '4', name: '其他合同' }],
            predActive: '-1',
    ...
    methods: {
        loadData: function loadData() {
            ...
            wx.request({
                method: 'post',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].defaulthost + 'getContractAll.do?cId=' + __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].userData.cId, //接口地址
                data: data,
                header: {
        ...
        toAgreementDetail: function toAgreementDetail(e, val) {
            ...
            __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].information.agreementDetailData = { contract_id: val.contract_id, customerpool_id: val.customerpool_id, contract_name: val.contract_name };
            global.mpvue.navigateTo({ url: url });
        }
    }
});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-73f7fe1e", esExports)
  }
}
