...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        loadData: function loadData() {
            ...
            var opportunityinfo = __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].information.opportunityDetailData;
            var data = {
            ...
            wx.request({
                ...
                success: function success(res) {
                    var info = res.data.map.success[0];

                    var probability = info.opportunityProgress[0].progress_probability;
                    var theTime = info.opportunityProgress[0].createTime;
                    if (probability == '100') {
